...
printCap _ _ _ _ (AsyncEndpointCap id badge rights) = text "AsyncEndpointCap" <+>
    printID id <+> num badge <+> printRights rights
...
printHeader name =
    text "theory" <+> doubleQuotes (printFileName name) $+$ text "imports Types_D"
    $+$ text "begin"
