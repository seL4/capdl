...
syn keyword CapDLAttribute addr affinity badge dom fault_ep G guard guard_size init ip max_prio prio sp R RG RX RW RWG W WG WX paddr cached uncached execute execute_never
syn match CapDLCPP "[ \t]*#.*$"
